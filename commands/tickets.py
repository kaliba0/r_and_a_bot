...
class ServiceSelect(discord.ui.Select):
    def __init__(self, bot: commands.Bot):
        ...
        options = [
            ...
            discord.SelectOption(label="GAME BOOST", value="game", description="Brawl Stars tiermax, ranked ranks, ...", emoji="<:rank35:1300477184527564872>"),
            ...
            discord.SelectOption(label="H4CK3R/DEV", value="dev", emoji="<:hacker:1314612811313446923>", description="App, bot, software developpment"),
